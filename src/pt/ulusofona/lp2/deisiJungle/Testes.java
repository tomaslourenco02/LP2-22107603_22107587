...
public class Testes {
    ...
    public void testJungle() {
        ...
        System.out.println(gamemaneger.moveCurrentPlayer2(3, true));
        System.out.println(Arrays.toString(gamemaneger.getPlayerInfo(4)));
        System.out.println(gamemaneger.moveCurrentPlayer2(5, true));
        System.out.println(Arrays.toString(gamemaneger.getPlayerInfo(6)));
        System.out.println(gamemaneger.moveCurrentPlayer2(0, true));
        System.out.println(Arrays.toString(gamemaneger.getPlayerInfo(4)));
        System.out.println(gamemaneger.moveCurrentPlayer2(4, true));
        System.out.println(Arrays.toString(gamemaneger.getPlayerInfo(6)));
